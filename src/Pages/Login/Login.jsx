...
const Login = () => {
  return (
    <div className="min-h-screen bg-[#F7F7F7] font-sans">
      ...
      {/* Main Content */}
      <main className="max-w-[662px] md:lg:mt-[96px] mt-[24px] mx-auto px-4 lg:md:py-8">
        <div className="flex flex-col items-center">
          ...
          <form className="md:lg:px-[154px] md:lg:w-fit w-full space-y-4">
            ...
            >
              <button
                type="submit"
                className=" bg-black lg:md:w-[353px] w-[320px] px-[14px]  text-white text-sm md:text-base lg:text-base lg:md:px-[102px] md:lg:py-[16px] py-[12px] rounded-[8px]  mt-[24px]"
              >
                Continue with email
              </button>
            </Link>
